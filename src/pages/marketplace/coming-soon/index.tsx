...
import ComingSoonContainer from 'components/Marketplace/ComingSoon';
import { withInjectAllSaga } from '../../../hocs/withAllSagaInjected';

const ComingSoon: FC & ComponentStatic = () => {
...
ComingSoon.renderLayout = renderMainLayout;

export default withInjectAllSaga(ComingSoon);
