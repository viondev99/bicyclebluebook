...
import DetailQuotes from 'components/PartnerPortal/TradeInScoreCard/History/ScoreCardList/HistoryQuotes/DetailQuotes';
import { withInjectAllSaga } from 'hocs/withAllSagaInjected';

const HistoryDetailQuotes: FC & ComponentStatic = () => {
...
HistoryDetailQuotes.renderLayout = renderMainLayout;

export default withInjectAllSaga(HistoryDetailQuotes);
