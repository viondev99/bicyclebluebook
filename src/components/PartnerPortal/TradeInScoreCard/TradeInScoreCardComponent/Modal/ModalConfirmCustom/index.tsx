...
import classes from './modal-confirm-custom.module.scss';
...
const ModalConfirmCustom: FC<Props> = (props) => {
  ...
  return (
    <Modal
      ...
      <div className={cx(classes.wrapButton, classes.bottomRight)}>
        <Button className={classes.btnSubmit} buttonType="danger" onClick={onSubmit}>
          Remove
        </Button>
...
export default memo(ModalConfirmCustom);
