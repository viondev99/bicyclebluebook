...
const SubStepOne: FC<Props> = ({
  ...
  const { indexScorecardSelected, listDataStepEbikeQuote } = useSelector(
  ...
  useEffect(() => {
    dispatch(getBrandFromYearModel(true));
  ...
  const handleChangeFormik = useCallback(
    (key: string, value: string) => {
      ...
      setFormStepDetailSubStepTwo(objChange);
      dispatch(
    ...
    [dispatch, form, indexScorecardSelected, listDataStepEbikeQuote, onChangeForm, setFormStepDetailSubStepTwo],
  );
