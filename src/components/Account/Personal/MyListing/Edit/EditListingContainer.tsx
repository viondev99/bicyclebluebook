...
import ListingForm from 'components/Account/Personal/MyListing/Form/FormUpdateListing';
...
const EditListingContainer = () => {
  ...
  return (
    <div className={cx('container', classes.container)}>
      ...
      <ListingForm initValues={initialValue} listFilter={listFilter} />
    </div>
  );
};
