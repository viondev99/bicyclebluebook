...
import FormUpdateListingPartsAccessories from 'components/Account/Personal/MyListing/Form/FormUpdateListingPartsAccessories';
...
import { components } from '../Form/form';
...
const EditListingContainer = () => {
  ...
  return (
    <div className={cx('container', classes.container)}>
      ...
      <FormUpdateListingPartsAccessories initValues={initialValue} listFilter={listFilter} />
    </div>
  );
};
