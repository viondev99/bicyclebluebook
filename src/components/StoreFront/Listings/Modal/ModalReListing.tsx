...
const ModalReListing: FC<Props> = ({ onClose, open, listingChecked }) => {
  ...
  return (
    <Modal
      ...
      title={'Confirm Re-list'}>
      <div className={classes.contentRenewModal}>
        This listing is de-listed <br />
        Are you sure you want to re-list this listing?
      </div>
