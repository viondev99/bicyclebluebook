...
import RefundOrderSkeleton from './RefundOrderSkeleton';
import classes from './refund-order.module.scss';
import OrderInfo from './OrderItem/OrderItem';
import { prepareData } from './form';
...
const RefundOrderContainer = () => {
  ...
  const renderPage = useMemo((): ReactElement => {
    ...
    return (
      <div>
        <OrderInfo order={order} amounts={amounts} onChangePriceRefund={onChangePriceRefund} errors={errors} />
