...
import { addStorefrontUser } from 'store/store-front/account/account.action';
...
const CreateUser: FC<Props> = ({ isOpen, onClose }) => {
  const dispatch = useDispatch();
  const { role, storefrontId, loading, success } = useSelector((store: StoreState) => {
    return {
  ...
  return (
    <Modal className={classes.createUserModal} centered={true} isOpen={isOpen} onClose={onClose} title={'Add New User'}>
