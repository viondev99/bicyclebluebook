...
import { verifyLinkResetPassword, resetPassword } from 'api/authenticate.api';
...
const ResetPasswordFullScreen: FC = () => {
  ...
  useEffect(() => {
    if (typeof query.ids === 'string') {
      verifyLinkResetPassword(query.ids)
        .then((response) => {
...
export default ResetPasswordFullScreen;
